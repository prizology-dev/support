...
To submit a GDPR data request, send an email to [support@prizology.net](mailto:support@prizology.net) with the subject line "GDPR Request". You will receive your data package within 30 days.
...
To close your Prizology account, send an email to [support@prizology.net](mailto:support@prizology.net) with the subject line "Account Closure". 
